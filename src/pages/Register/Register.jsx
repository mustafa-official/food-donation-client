...
const Register = () => {
  ...
  return (
    ...
    >
      <Helmet>
        <title>Pure Harvest | Register</title>
      </Helmet>
      <div className="w-full mx-auto mt-8 lg:mt-6 max-w-md px-4 md:px-8 py-8 mb-3 lg:mb-5 space-y-2 rounded-xl border  bg-[#ffffff11] text-gray-100">
        ...
        <form onSubmit={handleRegister} className="space-y-6">
          ...
          <button className="block w-full font-bold p-3 text-center rounded-sm  bg-[#00BBE4]">
            Register
          </button>
          {error && <small className="text-[#00BBE4]">{error}</small>}
        </form>
